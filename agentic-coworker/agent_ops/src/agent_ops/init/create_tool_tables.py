#!/usr/bin/env python3
"""
Script to create tool tables in the agent-portal database (PostgreSQL)
...
def create_tool_tables():
    """Create tool tables in the database"""
    try:
        logger.info("Starting tool tables creation...")
        ...
        logger.info("Successfully created tool tables, triggers, functions, and indexes.")

    except Exception as e:
        logger.error(f"Failed to create tool tables: {str(e)}")
        raise
